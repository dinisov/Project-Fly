function MOVING_GRATING(angle, cyclespersecond, f, drawmask, gratingsize)
...
movieDurationSecs=5;   % duration of each direction of the grating
...
%     masktex=Screen('MakeTexture', w, mask);
    ...
    for trial = 1:numberofTrials
        ...
        shiftperframe= (cyclespersecond * p * waitduration)*direction(trial);
